...
export const TEAM_ROSTER = [
  // Complex (5)
  { ownerId: "005Ts0000060ICnIAM", segment: "complex", alias: "Madalin", match: (n) => /gavril|madalin/.test(n) },
  { ownerId: "005Qs00000Mxc6EIAR", segment: "complex", alias: "Paul", match: (n) => (/paul/.test(n) || /ringheanu/.test(n)) && !/patru|patr(u|a)/.test(n) },
  { ownerId: "005Ts000005c4hFIAQ", segment: "complex", alias: "Corne", match: (n) => /corneliu/.test(n) && /(stefan|tefan)/.test(n) && /radu/.test(n) },
  { ownerId: "005Qs00000Pr1HKIAZ", segment: "complex", alias: "Vlad Popa", match: (n) => /vlad/.test(n) && /popa/.test(n) },
  { ownerId: "005Qs00000N2Hh3IAF", segment: "complex", alias: "Andrei Patru", match: (n) => /andrei/.test(n) && /patru|patr(u|a)/.test(n) },
  // Density (7)
  { ownerId: "005Ts000002AX4nIAG", segment: "density", alias: "Ciprian", match: (n) => /teodorescu/.test(n) },
  { ownerId: "005Ts00000BtGPDIA3", segment: "density", alias: "Daniel Boboc", match: (n) => /boboc/.test(n) },
  { ownerId: "005Ts00000BtX53IAF", segment: "density", alias: "Daniel Toltică", match: (n) => /toltic/.test(n) },
  { ownerId: "005Ts000002AWIQIA4", segment: "density", alias: "Eusebiu", match: (n) => /hanganu/.test(n) },
  { ownerId: "005Ts00000BtZV3IAN", segment: "density", alias: "Georgian", match: (n) => /borcaeas/.test(n) },
  { ownerId: "005Ts000001Ak10IAC", segment: "density", alias: "Mihnea", match: (n) => /mihnea/.test(n) },
  { ownerId: "005Ts000006V3vpIAC", segment: "density", alias: "Oroles", match: (n) => /oroles/.test(n) || (/rosu/.test(n) && !/borcaeas/.test(n)) },
];
