...
/**
 * Ordered since this activation: first delivered order on/after activated date.
 * Historical first_order before activation does not count (reactivations).
 */
export function hasOrderSinceActivation(activatedDate, firstOrderDate) {
 ...
 */
export function assembleChurnAccount(dbRow, { agentId, agentName, segment, sf, opportunityId }) {
  ...
  const ordered = hasOrderSinceActivation(activatedDate, firstOrderDate);
