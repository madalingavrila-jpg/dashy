 ...
 * Opportunity (scripts/.cache/sf-reactivation-*). Same dedup/attribution as the
 * base Active bucket; week = ISO week (Europe/Bucharest) of the reactivation
 * event date (first field-history transition INTO 'Activated' in the tracking
 * year, Won_Date__c fallback when the opp is already Activated) — mirrors MTD
