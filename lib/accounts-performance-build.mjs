...
/** Index monthly rows ([provider_id, month, gmv, orders, commission]) by provider. */
 ...
 */
export function assembleAccount(row, { agentId, agentName, segment, monthlyByProvider, qualityByProvider }) {
  const [
    providerId,
    ,
    ,
