...
let SecretProvidersConnectionsController = class SecretProvidersConnectionsController {
    ...
    async createConnection(_req, _res, body) {
    ...
    async updateConnection(_req, _res, providerKey, body) {
    ...
    async deleteConnection(_req, _res, providerKey) {
