...
let SourceControlImportService = class SourceControlImportService {
    ...
    async getRemoteCredentialsFromFiles(context) {
        ...
        const remoteCredentialFilesRead = await Promise.all(remoteCredentialFiles.map(async (file) => {
            ...
            const remote = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(file, { encoding: 'utf8' }));
            return remote;
        }));
    ...
    async getRemoteVariablesFromFile() {
        ...
        if (variablesFile.length > 0) {
            ...
            return (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(variablesFile[0], { encoding: 'utf8' }), {
                fallbackValue: [],
            });
        }
        return [];
    ...
    async getRemoteDataTablesFromFiles() {
        ...
        const remoteTables = await Promise.all(dataTableFiles.map(async (file) => {
            ...
            try {
                return (0, n8n_workflow_2.jsonParse)(fileContent);
            }
            catch (error) {
    ...
    async getRemoteFoldersAndMappingsFromFile(context) {
        ...
        if (foldersFile.length > 0) {
            ...
            const mappedFolders = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(foldersFile[0], { encoding: 'utf8' }), {
    ...
    async getRemoteTagsAndMappingsFromFile(context) {
        ...
        if (tagsFile.length > 0) {
            ...
            const mappedTags = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(tagsFile[0], { encoding: 'utf8' }), { fallbackValue: { tags: [], mappings: [] } });
    ...
    async getRemoteProjectsFromFiles(context) {
        ...
        const remoteProjects = await Promise.all(remoteProjectFiles.map(async (file) => {
            ...
            const fileContent = await (0, promises_1.readFile)(file, { encoding: 'utf8' });
            const parsedProject = (0, n8n_workflow_2.jsonParse)(fileContent);
            return {
                ...parsedProject,
    ...
    async importSingleWorkflowFromFile(candidate, userId, autoPublish, existingWorkflows, existingFolderIds, allSharedWorkflows, personalProject) {
        ...
        if (upsertResult?.identifiers?.length !== 1) {
            throw new n8n_workflow_2.UnexpectedError('Failed to upsert workflow', {
        ...
        try {
            ...
            const e = (0, n8n_workflow_2.ensureError)(error);
    ...
    async parseWorkflowFromFile(file) {
        ...
        try {
            ...
            throw new n8n_workflow_2.UnexpectedError(`Failed to parse workflow file ${file}: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    ...
    async unpublishWorkflow(workflowId, userId) {
        ...
        try {
            ...
            const error = (0, n8n_workflow_2.ensureError)(e);
    ...
    async importCredentialsFromWorkFolder(candidates, userId) {
        ...
        importCredentialsResult = await Promise.all(candidates.map(async (candidate) => {
            ...
            const credential = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(candidate.file, { encoding: 'utf8' }));
    ...
    async importTagsFromWorkFolder(candidate, user) {
        ...
        try {
            ...
            mappedTags = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(candidate.file, { encoding: 'utf8' }), { fallbackValue: { tags: [], mappings: [] } });
        }
        catch (e) {
            const error = (0, n8n_workflow_2.ensureError)(e);
        ...
        await Promise.all(mappedTags.tags.map(async (tag) => {
            ...
            if (findByName && findByName.id !== tag.id) {
                throw new n8n_workflow_2.UserError(`A tag with the name <strong>${tag.name}</strong> already exists locally.<br />Please either rename the local tag, or the remote one with the id <strong>${tag.id}</strong> in the tags.json file.`);
            }
    ...
    async importFoldersFromWorkFolder(user, candidate) {
        ...
        try {
            ...
            mappedFolders = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(candidate.file, { encoding: 'utf8' }), {
                fallbackValue: { folders: [] },
            });
        }
        catch (e) {
    ...
    async importVariablesFromWorkFolder(candidate, valueOverrides) {
        ...
        try {
            ...
            importedVariables = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(candidate.file, { encoding: 'utf8' }), { fallbackValue: [] });
        }
        catch (e) {
    ...
    async importDataTablesFromWorkFolder(candidates, userId) {
        ...
        for (const candidate of candidates) {
            try {
                ...
                const dataTable = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(candidate.file, { encoding: 'utf8' }));
                ...
                this.logger.error(`Failed to import data table ${candidate.name}`, {
                    error: (0, n8n_workflow_2.ensureError)(error),
                });
            }
        }
        return result;
    ...
    async importTeamProjectsFromWorkFolder(candidates, pullingUserId) {
        ...
        for (const candidate of candidates) {
            try {
                ...
                const project = (0, n8n_workflow_2.jsonParse)(await (0, promises_1.readFile)(candidate.file, { encoding: 'utf8' }));
                ...
                const errorMessage = (0, n8n_workflow_2.ensureError)(error);
    ...
    async findOwnerProjectInLocalDb(owner) {
        ...
        throw new n8n_workflow_2.UnexpectedError(`Unknown resource owner type "${typeof errorOwner !== 'string' ? errorOwner.type : 'UNKNOWN'}" found when finding owner project`);
    }
