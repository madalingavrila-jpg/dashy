...
let CommunityNodeTypesService = class CommunityNodeTypesService {
    ...
    async detectUpdates(environment) {
        ...
        try {
            communityNodesMetadata = await (0, community_node_types_utils_1.getCommunityNodesMetadata)(environment);
        }
        catch (error) {
    ...
    async fetchNodeTypes() {
        try {
            ...
            if (this.config.enabled && this.config.verifiedEnabled) {
                ...
                const qs = (0, strapi_utils_1.buildStrapiUpdateQuery)(typesToUpdate);
                data = await (0, community_node_types_utils_1.getCommunityNodeTypes)(environment, qs);
            }
            this.updateCommunityNodeTypes(data);
        }
        catch (error) {
