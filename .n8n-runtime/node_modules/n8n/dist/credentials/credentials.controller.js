...
let CredentialsController = class CredentialsController {
    ...
    async updateCredentials(req) {
        ...
        const preparedCredentialData = await this.credentialsService.prepareUpdateData(req.user, req.body, decryptedData);
    ...
    async shareCredentials(req) {
        ...
        const credential = await this.credentialsFinderService.findCredentialForUser(credentialId, req.user, ['credential:share']);
        if (!credential) {
            throw new forbidden_error_1.ForbiddenError();
        }
