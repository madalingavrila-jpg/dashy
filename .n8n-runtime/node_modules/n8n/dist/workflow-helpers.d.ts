...
import type { IDataObject, IRun, ITaskData, IWorkflowBase, IWorkflowSettings, RelatedExecution } from 'n8n-workflow';
...
export declare function removeDefaultValues(settings: IWorkflowSettings, defaultExecutionTimeout: number): IWorkflowSettings;
...
export declare function updateParentExecutionWithChildResults(executionRepository: ExecutionRepository, parentExecutionId: string, subworkflowResults: IRun): Promise<void>;
