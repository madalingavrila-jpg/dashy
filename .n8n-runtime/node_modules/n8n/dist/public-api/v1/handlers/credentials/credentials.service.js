...
async function saveCredential(payload, user) {
    ...
    (0, validation_1.validateExternalSecretsPermissions)(user, payload.data);
...
async function updateCredential(credentialId, user, updateData) {
    ...
    if (updateData.data !== undefined) {
        ...
        (0, validation_1.validateExternalSecretsPermissions)(user, updateData.data, decryptedData);
        let dataToEncrypt;
