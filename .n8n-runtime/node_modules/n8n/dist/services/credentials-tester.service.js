    ...
    async testCredentials(userId, credentialType, credentialsDecrypted) {
        ...
        if (credentialsDecrypted.data) {
            try {
                ...
                const canUseExternalSecrets = await this.credentialsHelper.credentialCanUseExternalSecrets(credentialsDecrypted);
                credentialsDecrypted.data = await this.credentialsHelper.applyDefaultsAndOverwrites(additionalData, credentialsDecrypted.data, credentialType, 'internal', canUseExternalSecrets, undefined, undefined);
            }
            catch (error) {
