...
let WorkflowsController = class WorkflowsController {
    ...
    async create(req, _res, body) {
        ...
        const savedWorkflow = await dbManager.transaction(async (transactionManager) => {
            ...
            if (projectId === undefined) {
                const personalProject = await this.projectRepository.getPersonalProjectForUserOrFail(req.user.id, transactionManager);
                projectId = personalProject.id;
            }
            project = await this.projectService.getProjectWithScope(req.user, projectId, ['workflow:create'], transactionManager);
            if (project === null) {
            ...
            await this.workflowHistoryService.saveVersion(req.user, workflow, workflow.id, autosaved, transactionManager);
    ...
    async runManually(req, _res) {
        ...
        const result = await this.workflowExecutionService.executeManually(req.body, req.user, req.headers['push-ref']);
