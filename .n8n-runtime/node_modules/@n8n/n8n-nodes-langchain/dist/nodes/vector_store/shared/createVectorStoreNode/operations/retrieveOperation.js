...
async function handleRetrieveOperation(context, args, embeddings, itemIndex) {
    const filter = (0, ai_utilities_1.getMetadataFiltersValues)(context, itemIndex);
    ...
    if (useReranker) {
        ...
        response = {
            reranker,
            vectorStore: (0, ai_utilities_1.logWrapper)(vectorStore, context),
        };
    }
    else {
        response = (0, ai_utilities_1.logWrapper)(vectorStore, context);
    }
    return {
        response,
        closeFunction: async () => {
