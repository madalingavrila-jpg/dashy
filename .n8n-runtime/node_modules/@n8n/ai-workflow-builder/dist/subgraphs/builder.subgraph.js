        ...
        const systemPromptTemplate = prompts_1.ChatPromptTemplate.fromMessages([
            [
                ...
                [
                    {
                        type: 'text',
                        text: (0, prompts_2.buildBuilderPrompt)({ includeExamples }),
                    },
                    {
                        type: 'text',
