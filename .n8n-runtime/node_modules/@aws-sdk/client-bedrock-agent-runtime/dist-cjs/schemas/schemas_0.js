...
const { AccessDeniedException, BadGatewayException, ConflictException, DependencyFailedException, InternalServerException, ModelNotReadyException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException } = require("../models/errors");
const _s_registry = TypeRegistry.for(_s);
const BedrockAgentRuntimeServiceException$ = [-3, _s, "BedrockAgentRuntimeServiceException", 0, [], []];
...
const ActionGroupInvocationInput$ = [3, n0, _AGII,
    0,
...
const AgentCollaboratorInputPayload$ = [3, n0, _ACIP,
    0,
    [_ty, _t, _rCR],
...
const AgentCollaboratorOutputPayload$ = [3, n0, _ACOP,
    0,
    [_ty, _t, _rCP],
...
const ApiInvocationInput$ = [3, n0, _AII,
    0,
...
const ApiParameter$ = [3, n0, _APp,
    0,
    [_n, _ty, _va],
    [0, 0, 0]
];
exports.ApiParameter$ = ApiParameter$;
const ApiRequestBody$ = [3, n0, _ARB,
    0,
    [_co],
    [() => ApiContentMap]
];
...
const Attribution$ = [3, n0, _A,
    0,
    [_ci],
    [[() => Citations, 0]]
];
exports.Attribution$ = Attribution$;
const AudioSegment$ = [3, n0, _AS,
    0,
    [_sU, _tr],
    [0, 0], 1
];
...
const ByteContentFile$ = [3, n0, _BCF,
    0,
    [_mT, _da],
...
const CreateSessionRequest$ = [3, n0, _CSR,
    0,
    [_sM, _eKA, _ta],
    [128 | 0, 0, 128 | 0]
];
...
const ExternalSourcesRetrieveAndGenerateConfiguration$ = [3, n0, _ESRAGC,
    0,
    [_mA, _so, _gCe],
...
const GetExecutionFlowSnapshotResponse$ = [3, n0, _GEFSRe,
    0,
...
const GetInvocationStepResponse$ = [3, n0, _GISRe,
    0,
    [_iS],
    [[() => InvocationStep$, 0]], 1
];
...
const GuardrailConfiguration$ = [3, n0, _GCu,
    0,
    [_gI, _gV],
    [0, 0], 2
];
exports.GuardrailConfiguration$ = GuardrailConfiguration$;
const GuardrailConfigurationWithArn$ = [3, n0, _GCWA,
    0,
    [_gIu, _gV],
    [0, 0], 2
];
...
const InlineAgentReturnControlPayload$ = [3, n0, _IARCP,
    8,
    [_iInv, _iI],
...
const InlineSessionState$ = [3, n0, _ISS,
    0,
...
const InputImage$ = [3, n0, _IIn,
    0,
    [_fo, _iCn],
    [0, [() => ByteContentBlob, 0]], 2
];
exports.InputImage$ = InputImage$;
const InvocationInput$ = [3, n0, _IInv,
    8,
...
const KnowledgeBaseLookupInput$ = [3, n0, _KBLI,
    0,
    [_t, _kBI],
...
const KnowledgeBaseQuery$ = [3, n0, _KBQ,
    8,
    [_ty, _t, _ima],
    [0, 0, [() => InputImage$, 0]]
];
...
const Metadata$ = [3, n0, _Me,
    8,
    [_sTt, _eTnd, _tTM, _oTTM, _cRI, _u],
    [5, 5, 1, 1, 0, [() => Usage$, 0]]
];
exports.Metadata$ = Metadata$;
const MetadataAttributeSchema$ = [3, n0, _MAS,
    8,
    [_k, _ty, _d],
    [0, 0, 0], 3
];
exports.MetadataAttributeSchema$ = MetadataAttributeSchema$;
const MetadataConfigurationForReranking$ = [3, n0, _MCFR,
    0,
    [_sMe, _sMC],
...
const ModelInvocationInput$ = [3, n0, _MII,
    8,
...
const OptimizedPromptEvent$ = [3, n0, _OPE,
    8,
    [_oP],
    [[() => OptimizedPrompt$, 0]]
];
exports.OptimizedPromptEvent$ = OptimizedPromptEvent$;
const OptimizePromptRequest$ = [3, n0, _OPR,
    0,
    [_i, _tMI],
    [[() => InputPrompt$, 0], 0], 2
];
exports.OptimizePromptRequest$ = OptimizePromptRequest$;
const OptimizePromptResponse$ = [3, n0, _OPRp,
    0,
    [_oP],
...
const OrchestrationModelInvocationOutput$ = [3, n0, _OMIO,
    8,
    [_tI, _rRa, _me, _rCea],
...
const ParameterDetail$ = [3, n0, _PD,
    0,
    [_ty, _d, _req],
    [0, 0, 2], 1
];
...
const PostProcessingModelInvocationOutput$ = [3, n0, _PPMIO,
    8,
...
const PostProcessingParsedResponse$ = [3, n0, _PPPR,
    8,
    [_t],
    [[() => OutputString, 0]]
];
exports.PostProcessingParsedResponse$ = PostProcessingParsedResponse$;
const PreProcessingModelInvocationOutput$ = [3, n0, _PPMIOr,
    8,
    [_tI, _pR, _rRa, _me, _rCea],
...
const PreProcessingParsedResponse$ = [3, n0, _PPPRr,
    8,
    [_ra, _iV],
    [[() => RationaleString, 0], 2]
];
exports.PreProcessingParsedResponse$ = PreProcessingParsedResponse$;
const PromptConfiguration$ = [3, n0, _PCr,
    0,
...
const RetrievalResultContent$ = [3, n0, _RRC,
    8,
...
const RetrievalResultContentColumn$ = [3, n0, _RRCC,
    8,
    [_cNol, _cV, _ty],
    [0, 0, 0]
];
...
const RetrieveAndGenerateInput$ = [3, n0, _RAGI,
    8,
    [_t],
    [0], 1
];
exports.RetrieveAndGenerateInput$ = RetrieveAndGenerateInput$;
const RetrieveAndGenerateOutput$ = [3, n0, _RAGO,
    8,
    [_t],
    [0], 1
];
exports.RetrieveAndGenerateOutput$ = RetrieveAndGenerateOutput$;
const RetrieveAndGenerateOutputEvent$ = [3, n0, _RAGOE,
    8,
    [_t],
    [0], 1
];
...
const RetrieveAndGenerateSessionConfiguration$ = [3, n0, _RAGSC,
    0,
    [_kKA],
    [0], 1
];
...
const RetrievedReference$ = [3, n0, _RRet,
    0,
    [_co, _l, _me],
...
const S3ObjectDoc$ = [3, n0, _SOD,
    0,
    [_uri],
    [0], 1
];
exports.S3ObjectDoc$ = S3ObjectDoc$;
const S3ObjectFile$ = [3, n0, _SOF,
    0,
    [_uri],
    [0], 1
];
exports.S3ObjectFile$ = S3ObjectFile$;
const SatisfiedCondition$ = [3, n0, _SC,
    8,
    [_cNo],
    [0], 1
];
exports.SatisfiedCondition$ = SatisfiedCondition$;
const SessionState$ = [3, n0, _SS,
    0,
...
exports.Span$ = Span$;
const StartFlowExecutionRequest$ = [3, n0, _SFER,
    0,
...
const StartFlowExecutionResponse$ = [3, n0, _SFERt,
    0,
    [_eA],
    [0]
];
...
const StreamingConfigurations$ = [3, n0, _SCt,
    0,
    [_sFR, _aGI],
    [2, 1]
];
...
const TransformationConfiguration$ = [3, n0, _TC,
    0,
    [_mo, _tTSC],
...
const VectorSearchBedrockRerankingModelConfiguration$ = [3, n0, _VSBRMC,
    0,
    [_mA, _aMRF],
    [0, 128 | 15], 1
];
exports.VectorSearchBedrockRerankingModelConfiguration$ = VectorSearchBedrockRerankingModelConfiguration$;
const VectorSearchRerankingConfiguration$ = [3, n0, _VSRC,
    0,
    [_ty, _bRC],
...
var TagsMap = 128 | 0;
const ActionGroupExecutor$ = [4, n0, _AGE,
    0,
    [_lam, _cCu],
    [0, 0]
];
...
const BedrockSessionContentBlock$ = [4, n0, _BSCBe,
    8,
    [_t, _ima],
    [0, () => ImageBlock$]
];
exports.BedrockSessionContentBlock$ = BedrockSessionContentBlock$;
const Caller$ = [4, n0, _Ca,
    0,
    [_aAA],
    [0]
];
exports.Caller$ = Caller$;
const ContentBlock$ = [4, n0, _CBon,
    8,
    [_t],
    [0]
];
exports.ContentBlock$ = ContentBlock$;
const FlowExecutionContent$ = [4, n0, _FEC,
    8,
    [_do],
    [15]
];
exports.FlowExecutionContent$ = FlowExecutionContent$;
const FlowExecutionEvent$ = [4, n0, _FEElow,
    0,
...
const FlowInputContent$ = [4, n0, _FIC,
    8,
    [_do],
    [15]
];
exports.FlowInputContent$ = FlowInputContent$;
const FlowMultiTurnInputContent$ = [4, n0, _FMTIC,
    0,
    [_do],
    [15]
];
exports.FlowMultiTurnInputContent$ = FlowMultiTurnInputContent$;
const FlowOutputContent$ = [4, n0, _FOC,
    0,
    [_do],
    [15]
];
...
const OrchestrationExecutor$ = [4, n0, _OE,
    0,
    [_lam],
    [0]
];
exports.OrchestrationExecutor$ = OrchestrationExecutor$;
const OrchestrationTrace$ = [4, n0, _OT,
    8,
...
const RerankingMetadataSelectiveModeConfiguration$ = [4, n0, _RMSMC,
    0,
    [_fTI, _fTEi],
...
const RetrievalFilter$ = [4, n0, _RF,
    8,
