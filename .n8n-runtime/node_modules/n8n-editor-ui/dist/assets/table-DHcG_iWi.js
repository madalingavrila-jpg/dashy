...
import { $ as onUpdated, $t as hasOwn, Bt as toRaw, C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, F as getCurrentInstance, G as nextTick, Gt as unref, Ht as toRefs, It as ref, J as onBeforeUnmount, L as h, M as createVNode, P as defineComponent, Q as onUnmounted, T as createBlock, Z as onMounted, _ as Fragment, _t as watch, at as renderSlot, bn as normalizeStyle, bt as withCtx, cn as isObject, ct as resolveDynamicComponent, et as openBlock, g as Comment, h as withModifiers, it as renderList, j as createTextVNode, jt as isRef, mn as isString, nn as isArray, nt as provide, ot as resolveComponent, p as vShow, pt as useSlots, q as onBeforeMount, st as resolveDirective, tn as init_shared_esm_bundler, u as vModelCheckbox, vn as normalizeClass, vt as watchEffect, w as createBaseVNode, xt as withDirectives, z as inject } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { $n as removeClass, $t as ElIcon, An as arrow_down_default, Br as _baseAssignValue_default, Cn as withNoopInstall, Cr as _Stack_default, Dr as _castPath_default, Er as _baseGet_default, Fr as isArguments_default, Gr as isObject_default, Hr as _defineProperty_default, Jr as isObjectLike_default, Kr as isArray_default, Lr as isArrayLike_default, Mn as arrow_right_default, Nn as arrow_up_default, On as buildProps, Or as keys_default, Pr as isBuffer_default, Qn as hasClass, Qt as useFormSize, Tr as get_default, Ur as isFunction_default, Ut as ElTooltip, Vr as _isIndex_default, Vt as ClickOutside, Wn as loading_default, Wr as identity_default, Xt as useFormItemInputId, Yn as addClass, Yr as _baseGetTag_default, Yt as useFormItem, Zt as useFormDisabled, _n as UPDATE_MODEL_EVENT, ai as isClient, an as useDelayedToggle, ar as isBoolean, cr as isNumber, ei as useEventListener, en as _export_sfc, er as debugWarn, fr as isNil_default, gr as hasIn_default, hr as _baseIteratee_default, in as useZIndex, jr as isTypedArray_default, kn as definePropType, ln as useNamespace, lr as isUndefined, mr as debounce_default, or as isElement, pr as isEqual_default, qr as _arrayMap_default, qt as ElScrollbar, rn as useSizeProp, rr as getProp, sn as yn, ti as useResizeObserver, tr as throwError, un as useLocale, ur as _baseSet_default, xn as withInstall, zr as eq_default } from "./src-BsVsetYf.js";
import { a as _getPrototype_default, c as _copyArray_default, i as _cloneBuffer_default, n as _cloneTypedArray_default, o as keysIn_default, s as _copyObject_default, t as _initCloneObject_default } from "./_initCloneObject-Ba-TKqya.js";
import { n as _baseFlatten_default, t as flatten_default } from "./flatten-C07oSq9e.js";
...
var useCheckboxStatus = (props, slots, { model }) => {
	...
	const isChecked = computed(() => {
		...
		else if (isArray(value)) if (isObject(props.label)) return value.map(toRaw).some((o$1) => isEqual_default(o$1, props.label));
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(!unref(hasOwnLabel) && unref(isLabeledByFormItem) ? "span" : "label"), {
				...
				}, null, 42, _hoisted_1$3)), [[vModelCheckbox, unref(model)]]) : withDirectives((openBlock(), createElementBlock("input", {
					key: 1,
					id: unref(inputId),
				...
				}, null, 42, _hoisted_2$3)), [[vModelCheckbox, unref(model)]]), createBaseVNode("span", { class: normalizeClass(unref(ns).e("inner")) }, null, 2)], 2), unref(hasOwnLabel) ? (openBlock(), createElementBlock("span", {
					key: 0,
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("label", { class: normalizeClass(unref(labelKls)) }, [_ctx.trueLabel || _ctx.falseLabel ? withDirectives((openBlock(), createElementBlock("input", {
				...
				onBlur: _cache[3] || (_cache[3] = ($event) => isFocused.value = false),
				onClick: _cache[4] || (_cache[4] = withModifiers(() => {}, ["stop"]))
			}, null, 42, _hoisted_1$2)), [[vModelCheckbox, unref(model)]]) : withDirectives((openBlock(), createElementBlock("input", {
				key: 1,
				"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => isRef(model) ? model.value = $event : null),
				class: normalizeClass(unref(ns).be("button", "original")),
				type: "checkbox",
				...
				onBlur: _cache[8] || (_cache[8] = ($event) => isFocused.value = false),
				onClick: _cache[9] || (_cache[9] = withModifiers(() => {}, ["stop"]))
			}, null, 42, _hoisted_2$2)), [[vModelCheckbox, unref(model)]]), _ctx.$slots.default || _ctx.label ? (openBlock(), createElementBlock("span", {
				key: 2,
