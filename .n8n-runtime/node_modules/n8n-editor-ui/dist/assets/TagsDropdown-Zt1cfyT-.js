...
import { g as onClickOutside, yt as useI18n } from "./_MapCache-CrDDrJ83.js";
import { Hi as N8nIcon_default, lt as N8nSelect_default, ut as N8nOption_default } from "./src-BsVsetYf.js";
import { Lr as v4_default, qa as MAX_TAG_NAME_LENGTH, yr as useToast } from "./users.store-yKax6vGx.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				default: withCtx(() => [
					__props.createEnabled && options.value.length === 0 && filter.value ? (openBlock(), createBlock(unref(N8nOption_default), {
						key: CREATE_KEY,
						ref_key: "createRef",
						ref: createRef,
						value: CREATE_KEY,
						...
						default: withCtx(() => [__props.createEnabled ? (openBlock(), createElementBlock("span", _hoisted_1, toDisplayString(unref(i18n).baseText("tagsDropdown.typeToCreateATag")), 1)) : __props.allTags.length > 0 ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(unref(i18n).baseText("tagsDropdown.noMatchingTagsExist")), 1)) : (openBlock(), createElementBlock("span", _hoisted_3, toDisplayString(unref(i18n).baseText("tagsDropdown.noTagsExist")), 1))]),
						_: 1
					...
					__props.manageEnabled ? (openBlock(), createBlock(unref(N8nOption_default), {
						key: MANAGE_KEY,
						value: MANAGE_KEY,
