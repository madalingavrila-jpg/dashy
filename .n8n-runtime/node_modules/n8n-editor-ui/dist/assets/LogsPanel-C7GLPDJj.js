...
import { A as useFileDialog, B as useTimestamp, b as useActiveElement, bt as I18nT, yt as useI18n } from "./_MapCache-CrDDrJ83.js";
import { Ai as N8nIconButton_default, Bi as N8nButton_default, Fi as useProvideTooltipAppendTo, Hi as N8nIcon_default, I as N8nRadioButtons_default, N as N8nResizeWrapper_default, Ti as N8nTooltip_default, bi as useRoute, pi as N8nLink_default, wt as N8nActionDropdown_default, xi as useRouter, zi as N8nText_default } from "./src-BsVsetYf.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $ as require_upperFirst, Bt as useNDVStore, C as useNodeTypesStore, Hc as getScrollbarWidth, It as useNodeHelpers, Lr as v4_default, Lt as useTelemetry, S as waitingNodeTooltip, Sr as useCanvasStore, Tr as useMessage, Vt as injectWorkflowState, d as isChatNode, fn as useDocumentTitle, r as useUIStore, s as useWorkflowsStore, wr as useSourceControlStore, yr as useToast } from "./users.store-yKax6vGx.js";
import { bc as PopOutWindowKey, bs as MODAL_CONFIRM, ns as VIEWS } from "./constants-CtA9jyV-.js";
...
import { n as RunDataItemCount_default, t as RunData_default } from "./RunData-DMUZd8Zb.js";
import { t as NDVEmptyState_default } from "./NDVEmptyState-BuTIQOIa.js";
import { t as usePinnedData } from "./usePinnedData-6cs4oFEc.js";
import { _ as MessageComponentKey, a as useLogsStore, c as LOCAL_STORAGE_PANEL_WIDTH, d as chatEventBus, f as constructChatWebsocketUrl, g as ChatSymbol, h as ChatOptionsSymbol, i as useExperimentalNdvStore, l as LOGS_PANEL_STATE, m as shouldBlockUserInput, o as LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH, p as parseBotChatMessageContent, r as canvasEventBus, s as LOCAL_STORAGE_PANEL_HEIGHT, t as useCanvasOperations, u as LOG_DETAILS_PANEL_STATE, v as MessageWithButtons_default, y as MarkdownRenderer_default } from "./useCanvasOperations-CtjMC9Vr.js";
import { t as NodeIcon_default } from "./NodeIcon-Be4Kw4K9.js";
import { t as useRunWorkflow } from "./useRunWorkflow-BIyMxaO6.js";
...
import { t as convertFileToBinaryData } from "./fileUtils-CO9TbNVD.js";
...
import { n as ChatFile_default, t as useResizablePanel } from "./useResizablePanel-CQjZF6zc.js";
		...
		if (response) {
			if (respondNodesResponseMode.value) {
				...
				ws.value.onmessage = (event) => {
					...
					const newMessage = {
						...parseBotChatMessageContent(event.data),
...
var MessagesList_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return __props.emptyText && unref(initialMessages).length === 0 && __props.messages.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_1$1, [createBaseVNode("div", _hoisted_2, [createVNode(unref(N8nIcon_default), {
				icon: "message-circle",
				size: "large",
				class: "emptyIcon"
			}), createVNode(unref(N8nText_default), {
...
var MessageOptionTooltip_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_1lun2_125",
	icon: "_icon_1lun2_131"
};
...
var MessageOptionAction_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [createVNode(unref(N8nTooltip_default), { placement: __props.placement }, {
				content: withCtx(() => [createTextVNode(toDisplayString(__props.label), 1)]),
...
var MessageOptionAction_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_1clrm_125",
	icon: "_icon_1clrm_131"
};
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createVNode(LogsPanelHeader_default, {
					...
					actions: withCtx(() => [unref(clipboard).isSupported && !__props.isReadOnly ? (openBlock(), createBlock(unref(N8nTooltip_default), { key: 0 }, {
						content: withCtx(() => [
						...
						_: 1
					})) : createCommentVNode("", true), __props.messages.length > 0 && !__props.isReadOnly ? (openBlock(), createBlock(unref(N8nTooltip_default), {
						key: 1,
				...
				__props.isOpen ? (openBlock(), createElementBlock("main", {
					key: 0,
					...
					beforeMessage: withCtx(({ message }) => [
						!__props.isReadOnly && message.sender === "bot" && !message.id.includes("preload") ? (openBlock(), createBlock(MessageOptionTooltip_default, {
							key: 0,
							placement: "right",
						...
						!__props.isReadOnly && isTextMessage(message) && message.sender === "user" ? (openBlock(), createBlock(MessageOptionAction_default, {
							key: 1,
				...
				}, createSlots({ _: 2 }, [__props.pastChatMessages.length > 0 ? {
					name: "leftPanel",
...
var ChatMessagesPanel_vue_vue_type_style_index_0_lang_module_default = {
	chat: "_chat_14gab_125",
	chatHeader: "_chatHeader_14gab_185",
	chatTitle: "_chatTitle_14gab_198",
	session: "_session_14gab_202",
	sessionId: "_sessionId_14gab_210",
	copyable: "_copyable_14gab_216",
	headerButton: "_headerButton_14gab_220",
	newHeaderButton: "_newHeaderButton_14gab_225",
	chatBody: "_chatBody_14gab_230",
	messages: "_messages_14gab_239",
	messagesInput: "_messagesInput_14gab_250",
	messagesHistory: "_messagesHistory_14gab_284"
};
