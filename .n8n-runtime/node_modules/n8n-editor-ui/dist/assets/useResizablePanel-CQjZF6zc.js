import { C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, Gt as unref, It as ref, M as createVNode, P as defineComponent, T as createBlock, _t as watch, et as openBlock, h as withModifiers, w as createBaseVNode } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { M as useLocalStorage } from "./_MapCache-CrDDrJ83.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("p", _hoisted_1, toDisplayString(__props.file.name), 1),
				__props.isRemovable ? (openBlock(), createElementBlock("span", {
					key: 0,
					class: "chat-file-delete",
					"data-test-id": "chat-file-remove",
					onClick: withModifiers(onDelete, ["stop"])
				}, [createVNode(unref(closeThick_default))])) : __props.isPreviewable || __props.href ? (openBlock(), createBlock(unref(openInNew_default), {
					key: 1,
...
export { ChatFile_default as n, useResizablePanel as t };
