...
import { bt as I18nT, ot as useDebounceFn, yt as useI18n } from "./_MapCache-CrDDrJ83.js";
import { B as N8nNotice_default, Bi as N8nButton_default, Dt as N8nBadge_default, E as N8nUserInfo_default, Hi as N8nIcon_default, Li as N8nHeading_default, Mi as N8nActionBox_default, Ot as ElSwitch, St as N8nActionToggle_default, Ti as N8nTooltip_default, d as N8nDataTableServer_default, ki as Input_default, pi as N8nLink_default, wt as N8nActionDropdown_default, zi as N8nText_default } from "./src-BsVsetYf.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-DjneYy0u.js";
import { Ar as usePostHog, To as INVITE_USER_MODAL_KEY, Tr as useMessage, co as DELETE_USER_MODAL_KEY, fn as useDocumentTitle, r as useUIStore, t as useUsersStore, ur as hasPermission, xs as useSettingsStore, yr as useToast } from "./users.store-yKax6vGx.js";
import { t as ElRadio } from "./radio-BHzWdJ6t.js";
import { t as Alert_default } from "./Alert-CpcrMn1Z.js";
import { $r as ROLE, Gc as EnterpriseEditionFeature, Jc as DEBOUNCE_TIME, Vc as TAMPER_PROOF_INVITE_LINKS, bs as MODAL_CONFIRM, nl as getDebounceTime, ui as USERS_LIST_SORT_OPTIONS } from "./constants-CtA9jyV-.js";
...
import { r as formatTimeAgo } from "./dateFormatter-CQs9Cspw.js";
import { t as EnterpriseEdition_ee_default } from "./EnterpriseEdition.ee-m3c4W2uW.js";
import { n as useSSOStore } from "./sso.store-BOCAFeKA.js";
import { t as useUserRoleProvisioningStore } from "./userRoleProvisioning.store-vgqb2gdx.js";
...
var SettingsUsersRoleCell_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const roleLabel$1 = computed(() => props.roles[currentRole.value]?.label);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [isEditable.value ? (openBlock(), createBlock(unref(N8nActionDropdown_default), {
				...
				activator: withCtx(() => [createBaseVNode("button", {
					...
					_: 1
				}), props.loading ? (openBlock(), createBlock(unref(N8nIcon_default), {
					key: 0,
					color: "text-dark",
					icon: "spinner",
					spin: "",
				...
				_: 1
			}, 8, ["items", "disabled"])) : (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(roleLabel$1.value), 1))]);
		};
	}
});
var SettingsUsersRoleCell_vue_vue_type_style_index_0_lang_module_default = {
	roleLabel: "_roleLabel_13imy_125",
	radioLabel: "_radioLabel_13imy_139",
	removeUser: "_removeUser_13imy_149"
};
...
var SettingsUsersProjectsCell_vue_vue_type_style_index_0_lang_module_default = {
	projects: "_projects_1ynwg_125",
	project: "_project_1ynwg_125",
	comma: "_comma_1ynwg_140",
	projectList: "_projectList_1ynwg_145"
};
			...
			return [
				{
					...
					guard: (user) => isTamperProofInviteLinksEnabled.value && hasPermission(["rbac"], { rbac: { scope: "user:generateInviteLink" } }) && usersStore.usersLimitNotReached && user.id !== usersStore.currentUserId && !user.firstName
				},
				{
					label: i18n.baseText("settings.users.actions.copyInviteLink"),
					value: "copyInviteLink",
					guard: (user) => !isTamperProofInviteLinksEnabled.value && usersStore.usersLimitNotReached && !user.firstName && !!user.inviteAcceptUrl
				},
				{
...
var SettingsUsersView_vue_vue_type_style_index_0_lang_module_default = {
	userCount: "_userCount_yo0sz_125",
	buttonContainer: "_buttonContainer_yo0sz_130",
	search: "_search_yo0sz_137",
	setupInfoContainer: "_setupInfoContainer_yo0sz_141",
	settingsContainer: "_settingsContainer_yo0sz_145",
	settingsContainerInfo: "_settingsContainerInfo_yo0sz_156",
	settingsContainerAction: "_settingsContainerAction_yo0sz_165",
	container: "_container_yo0sz_173"
};
