import { C as computed, Cn as toDisplayString, D as createElementBlock, Gt as unref, It as ref, L as h, P as defineComponent, _t as watch, et as openBlock, j as createTextVNode, w as createBaseVNode } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { yt as useI18n } from "./_MapCache-CrDDrJ83.js";
import { bi as useRoute, mt as createEventBus } from "./src-BsVsetYf.js";
import { Ba as CREDENTIAL_EDIT_MODAL_KEY, Bt as useNDVStore, Lr as v4_default, Lt as useTelemetry, it as chatWithAssistant, ot as replaceCode, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, st as useAIAssistantHelpers, t as useUsersStore, ur as hasPermission, va as codeNodeEditorEventBus, xs as useSettingsStore, yr as useToast, zc as STORES } from "./users.store-yKax6vGx.js";
import { Ba as deepCopy, es as EDITABLE_CANVAS_VIEWS } from "./constants-CtA9jyV-.js";
import { j as defineStore, r as useRootStore, v as assert } from "./_baseOrderBy-B5lXBmMF.js";
