...
import { m as require_isArray, yt as useI18n } from "./_MapCache-CrDDrJ83.js";
import { Hi as N8nIcon_default, _t as N8nCard_default, j as N8nTag_default, xi as useRouter, zi as N8nText_default } from "./src-BsVsetYf.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Ar as usePostHog, C as useNodeTypesStore, Lt as useTelemetry, Wt as require_toInteger, xn as useTemplatesStore, xs as useSettingsStore } from "./users.store-yKax6vGx.js";
import { Ac as EMPTY_STATE_EXPERIMENT, ns as VIEWS } from "./constants-CtA9jyV-.js";
import { n as require__isIterateeCall, p as require__copyArray } from "./merge-BLok1EPf.js";
import { d as makeRestApiRequest, j as defineStore, r as useRootStore } from "./_baseOrderBy-B5lXBmMF.js";
import { t as require_uniqBy } from "./uniqBy-iMocF-tq.js";
...
var require_sampleSize = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
async function getDynamicRecommendedTemplates(ctx) {
	return await makeRestApiRequest(ctx, "GET", "/dynamic-templates");
}
var import_sampleSize = /* @__PURE__ */ __toESM(require_sampleSize(), 1);
...
const useRecommendedTemplatesStore = defineStore("recommendedTemplates", () => {
	...
	const isFeatureEnabled = computed(() => {
		const isTemplatesVariant = posthogStore.getVariant(EMPTY_STATE_EXPERIMENT.name) === EMPTY_STATE_EXPERIMENT.variantTemplates;
		return settingsStore.isTemplatesEnabled && !templatesStore.hasCustomTemplatesHost && isTemplatesVariant;
	});
	...
	async function loadRecommendedTemplates() {
		...
		try {
			return (await getDynamicRecommendedTemplates(rootStore.restApiContext)).templates.map((template) => template.workflow).slice(0, 6);
		} catch (error) {
