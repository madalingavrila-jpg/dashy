...
import { C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, F as getCurrentInstance, G as nextTick, Gt as unref, It as ref, J as onBeforeUnmount, L as h, M as createVNode, P as defineComponent, Pt as reactive, T as createBlock, Ut as toValue, Z as onMounted, _ as Fragment, _t as watch, at as renderSlot, bn as normalizeStyle, bt as withCtx, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, mt as useTemplateRef, p as vShow, pt as useSlots, vn as normalizeClass, w as createBaseVNode, xt as withDirectives } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { D as useElementSize, G as isClient, J as noop, K as isIOS, P as useResizeObserver, W as directiveHooks, Y as notNullish, bt as I18nT, dt as isVue2, et as toRef, g as onClickOutside, h as computedAsync, it as tryOnScopeDispose, nt as toValue$1, ot as useDebounceFn, q as isObject, rt as tryOnMounted, st as useThrottleFn, yt as useI18n } from "./_MapCache-CrDDrJ83.js";
import { Ai as N8nIconButton_default, B as N8nNotice_default, Bi as N8nButton_default, Hi as N8nIcon_default, I as N8nRadioButtons_default, Ri as N8nCallout_default, Rt as ElCollapseTransition, Ti as N8nTooltip_default, bi as useRoute, bt as N8nBlockUi_default, f as require_get, k as N8nTabs_default, l as N8nInlineTextEdit_default, zi as N8nText_default } from "./src-BsVsetYf.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Bt as useNDVStore, C as useNodeTypesStore, Ca as COMMUNITY_NODES_INSTALLATION_DOCS_URL, Ea as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, Ir as useWorkflowsListStore, It as useNodeHelpers, Kt as ProjectTypes, Lt as useTelemetry, R as removePreviewToken, Tt as useWorkflowHelpers, Vt as injectWorkflowState, ma as importCurlEventBus, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, ui as useHistoryStore, w as useActionsGenerator, xr as useExternalHooks, xs as useSettingsStore, yi as RenameNodeCommand, yr as useToast } from "./users.store-yKax6vGx.js";
import { A as TitledList_default, O as NodeCredentials_default, d as useNodeSettingsParameters, f as collectParametersByTab, g as getNodeSettingsInitialValues, k as useNodeCredentialOptions, m as createCommonNodeSettings, p as collectSettings, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-YJg-iiGD.js";
import { n as ElRow, t as ElCol } from "./col-B30gA2Ds.js";
import { $t as DATA_TABLE_NODES, Ba as deepCopy, Eo as OPEN_AI_API_CREDENTIAL_TYPE, F as CUSTOM_API_CALL_KEY, Mn as MCP_TRIGGER_NODE_TYPE, Va as isCommunityPackageName, Wt as CHAT_TRIGGER_NODE_TYPE, Xn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, ao as NodeConnectionTypes, b as NPM_PACKAGE_DOCS_BASE_URL, ca as getNodeInputs, d as CUSTOM_NODES_DOCS_URL, hn as FORM_TRIGGER_NODE_TYPE, l as BUILTIN_NODES_DOCS_URL, ns as VIEWS, qn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, s as BASE_NODE_SURVEY_URL, ua as getNodeParameters } from "./constants-CtA9jyV-.js";
...
import { n as ndvEventBus } from "./assistant.store-TwZ65rq9.js";
...
import { t as useFreeAiCredits } from "./useFreeAiCredits-DvZy4lt7.js";
...
var FreeAiCreditsCallout_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const i18n = useI18n();
		const { aiCreditsQuota, userCanClaimOpenAiCredits, claimingCredits, claimCredits } = useFreeAiCredits();
		...
		const showCallout = computed(() => {
			return userCanClaimOpenAiCredits.value && (activeNodeHasOpenAiApiCredential.value || isEditingOpenAiCredential.value);
		});
		const onClaimCreditsClicked = async () => {
			if (await claimCredits("freeAiCreditsCallout")) showSuccessCallout.value = true;
		};
		return (_ctx, _cache) => {
			return showCallout.value && !showSuccessCallout.value ? (openBlock(), createBlock(unref(N8nCallout_default), {
				key: 0,
				theme: "secondary",
				icon: "circle-alert",
				class: "mt-xs"
...
const container$1 = "_container_1x2tc_142";
const connections = "_connections_1x2tc_150";
const connectionType = "_connectionType_1x2tc_163";
const connectionLabel = "_connectionLabel_1x2tc_170";
const hasIssues = "_hasIssues_1x2tc_176";
const connectedNodesWrapper = "_connectedNodesWrapper_1x2tc_180";
const plusButton = "_plusButton_1x2tc_188";
const connectedNodesWrapperExpanded = "_connectedNodesWrapperExpanded_1x2tc_206";
const connectedNodesMultiple = "_connectedNodesMultiple_1x2tc_212";
const connectedNode = "_connectedNode_1x2tc_180";
const connectedNodes = "_connectedNodes_1x2tc_180";
const nodeWrapper = "_nodeWrapper_1x2tc_251";
...
var NodeSettings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const currentWorkflow = computed(() => workflowsListStore.getWorkflowById(workflowsStore.workflowObject.id));
				...
				node.value && nodeValid.value ? (openBlock(), createElementBlock("div", {
					...
					withDirectives(createBaseVNode("div", null, [
						...
						nodeValuesInitialized.value ? (openBlock(), createBlock(ParameterInputList_default, {
							...
							default: withCtx(() => [!__props.isEmbeddedInCanvas && !isDemoPreview.value ? (openBlock(), createBlock(NodeCredentials_default, {
								key: 0,
								node: node.value,
								readonly: isReadOnly.value,
								"show-all": true,
...
var NodeSettings_vue_vue_type_style_index_0_lang_module_default = {
	header: "_header_1r29h_125",
	featureRequest: "_featureRequest_1r29h_129",
	uiBlockerNdvV2: "_uiBlockerNdvV2_1r29h_143"
};
var NodeSettings_default = /* @__PURE__ */ __plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-5e889187"]]);
