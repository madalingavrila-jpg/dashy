...
import { Ir as useWorkflowsListStore, Sr as useCanvasStore, ba as getWorkflowWriteLock, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, un as useBuilderStore, zc as STORES } from "./users.store-yKax6vGx.js";
import { ns as VIEWS, tl as TIME } from "./constants-CtA9jyV-.js";
...
const useCollaborationStore = defineStore(STORES.COLLABORATION, () => {
	...
	async function handleWorkflowUpdate() {
		if (isCurrentUserWriter.value || !collaboratingWorkflowId.value) return;
		try {
