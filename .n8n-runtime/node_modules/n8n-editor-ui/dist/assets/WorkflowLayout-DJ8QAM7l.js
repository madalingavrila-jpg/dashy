...
import { M as useLocalStorage, w as useDocumentVisibility, yt as useI18n } from "./_MapCache-CrDDrJ83.js";
import { A as SuggestedActions_default, Ai as N8nIconButton_default, Bi as N8nButton_default, Dt as N8nBadge_default, Gi as __vitePreload, Hi as N8nIcon_default, I as N8nRadioButtons_default, T as N8nUserStack_default, Ti as N8nTooltip_default, bi as useRoute, j as N8nTag_default, ji as AskAssistantButton_default, l as N8nInlineTextEdit_default, li as AskAssistantAvatar_default, mi as RouterLink, mt as createEventBus, wt as N8nActionDropdown_default, xi as useRouter } from "./src-BsVsetYf.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-DjneYy0u.js";
import { At as disposeWorkflowDocumentStore, Bt as useNDVStore, C as useNodeTypesStore, Ci as ResourceType, Dr as useWorkflowHistoryStore, Ft as useEnvironmentsStore, Gt as useProjectsStore, Ht as useWorkflowState, Ir as useWorkflowsListStore, K as getSampleWorkflowByTemplateId, Kt as ProjectTypes, Lt as useTelemetry, Or as require_FileSaver_min, Ot as useTagsStore, T as useEvaluationStore, Tr as useMessage, Tt as useWorkflowHelpers, Vc as getBannerRowHeight, Vt as injectWorkflowState, br as useStyles, fn as useDocumentTitle, hn as useWorkflowSaveStore, jt as useWorkflowDocumentStore, ka as PROJECT_MOVE_RESOURCE_MODAL, ki as getActivatableTriggerNodes, kt as createWorkflowDocumentId, pa as nodeViewEventBus, pn as useWorkflowSaving, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, ui as useHistoryStore, un as useBuilderStore, ur as hasPermission, wr as useSourceControlStore, xr as useExternalHooks, xs as useSettingsStore, yr as useToast, zt as telemetry } from "./users.store-yKax6vGx.js";
import "./MainSidebarHeader-CmJZs7dT.js";
import { t as BaseLayout_default } from "./BaseLayout-DRnUeQfL.js";
import { As as WORKFLOW_ACTIVE_MODAL_KEY, Bs as WORKFLOW_SHARE_MODAL_KEY, Cc as WorkflowIdKey, Gc as EnterpriseEditionFeature, Ko as getResourcePermissions, Ls as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Ps as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Qs as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, Rs as WORKFLOW_PUBLISH_MODAL_KEY, Sc as WorkflowDocumentStoreKey, Xc as LOADING_ANIMATION_MIN_DURATION, _l as WORKFLOW_MENU_ACTIONS, bs as MODAL_CONFIRM, g as EVALUATIONS_DOCS_URL, h as ERROR_WORKFLOW_DOCS_URL, hs as IMPORT_WORKFLOW_URL_MODAL_KEY, js as WORKFLOW_DESCRIPTION_MODAL_KEY, ls as DUPLICATE_MODAL_KEY, mr as STICKY_NODE_TYPE, ns as VIEWS, o as MAX_WORKFLOW_NAME_LENGTH, t as AutoSaveState, ts as MAIN_HEADER_TABS, v as N8N_MAIN_GITHUB_REPO_URL, w as TIME_SAVED_DOCS_URL, wc as WorkflowStateKey, yr as TIME_SAVED_NODE_TYPE, zs as WORKFLOW_SETTINGS_MODAL_KEY } from "./constants-CtA9jyV-.js";
...
import { n as require_debounce, t as useDebounce } from "./useDebounce-BLyJcepV.js";
...
import { t as useExternalSecretsStore } from "./externalSecrets.ee.store-DnuD9dq-.js";
...
import { n as useParentFolder, t as useCanvasOperations } from "./useCanvasOperations-CtjMC9Vr.js";
import { t as useFoldersStore } from "./folders.store-Dx3ZI_kr.js";
import "./ProjectIcon-GFY1puyl.js";
...
import { t as TimeAgo_default } from "./TimeAgo-DdfgFrUS.js";
import "./roles.store-DMZms_n7.js";
import "./KeyboardShortcutTooltip-DBU_SpqH.js";
import "./TagsDropdown-Zt1cfyT-.js";
import { t as WorkflowTagsDropdown_default } from "./WorkflowTagsDropdown-CGkj1MGo.js";
import { t as sanitizeFilename } from "./dist-BzasWbMR.js";
import "./sso.store-BOCAFeKA.js";
import { t as router_default } from "./router-DhZz_a9z.js";
import "./insights.store-BCK0pwnc.js";
import "./insights.constants-DT411L4j.js";
import "./insights.utils-rWSf7v_i.js";
import { a as MCP_DOCS_PAGE_URL, s as MCP_SETTINGS_VIEW } from "./mcp.constants-CZRs1GEe.js";
import "./sourceControl.eventBus-CxrpvwZH.js";
import { i as getLastPublishedVersion, r as generateVersionName } from "./utils-CzrkSDCm.js";
import { t as useMcp } from "./useMcp-DXyhxNdx.js";
import { t as useKeybindings } from "./useKeybindings-BhiF7QeB.js";
import { t as injectStrict } from "./injectStrict-UuetT1VE.js";
import { t as useWorkflowActivate } from "./useWorkflowActivate-k1iFAunP.js";
import "./useGlobalEntityCreation-DJLtho6X.js";
import { t as LoadingView_default } from "./LoadingView-DjiSz820.js";
...
import { t as useAITemplatesStarterCollectionStore } from "./aiTemplatesStarterCollection.store-BqQ2mHkb.js";
import { n as useReadyToRunWorkflowsStore, t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-DqEObpg3.js";
import { t as useExecutionDebugging } from "./useExecutionDebugging-BUyzYBA_.js";
import "./ProjectBreadcrumb-DWlq1ceb.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker--g4KzpVE.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-yT_Xnx78.js";
import { t as usePushConnection } from "./usePushConnection-BWUV9-nW.js";
	...
	async function initializeData() {
		...
		const loadPromises = (() => {
			...
			if (settingsStore.isEnterpriseFeatureEnabled[EnterpriseEditionFeature.ExternalSecrets]) {
				...
				if (route?.params?.projectId !== projectsStore.personalProject?.id && typeof route?.params?.projectId === "string") promises.push(externalSecretsStore.fetchProjectSecrets(route.params.projectId));
			}
			return promises;
		})();
