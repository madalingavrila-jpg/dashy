...
import { A as createStaticVNode, C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, Gt as unref, Ht as toRefs, I as guardReactiveProps, It as ref, J as onBeforeUnmount, M as createVNode, P as defineComponent, Pt as reactive, Q as onUnmounted, St as withMemo, T as createBlock, Vt as toRef, W as mergeProps, Z as onMounted, _ as Fragment, _t as watch, at as renderSlot, bn as normalizeStyle, bt as withCtx, c as useCssModule, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, k as createSlots, n as Transition, p as vShow, st as resolveDirective, vn as normalizeClass, w as createBaseVNode, xt as withDirectives, yn as normalizeProps } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { g as onClickOutside, gt as i18n, yt as useI18n } from "./_MapCache-CrDDrJ83.js";
import { Ai as N8nIconButton_default, B as N8nNotice_default, Bi as N8nButton_default, Ct as N8nLoading_default, H as N8nNodeCreatorNode_default, Hi as N8nIcon_default, Ri as N8nCallout_default, Ti as N8nTooltip_default, V as N8nNodeIcon_default, Y as N8nInfoTip_default, pi as N8nLink_default, zi as N8nText_default } from "./src-BsVsetYf.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-DjneYy0u.js";
import { A as getHumanInTheLoopActions, Ar as usePostHog, B as shouldShowCommunityNodeDetails, C as useNodeTypesStore, Ca as COMMUNITY_NODES_INSTALLATION_DOCS_URL, E as filterAndSearchNodes, In as getNewNodePosition, L as prepareCommunityNodeDetailsViewStack, Lt as useTelemetry, O as flattenCreateElements, P as isNodePreviewKey, R as removePreviewToken, Tn as DEFAULT_NODE_SIZE, U as transformNodeType, j as getRootSearchCallouts, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, w as useActionsGenerator, xr as useExternalHooks, xs as useSettingsStore } from "./users.store-yKax6vGx.js";
import { Dt as REGULAR_NODE_CREATOR_VIEW, F as CUSTOM_API_CALL_KEY, Gn as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, Ic as QUICK_CONNECT_EXPERIMENT, Kn as OPEN_AI_NODE_TYPE, L as DRAG_EVENT_DATA_KEY, Ot as REQUEST_NODE_FORM_URL, Sr as WEBHOOK_NODE_TYPE, St as HUMAN_IN_THE_LOOP_CATEGORY, Va as isCommunityPackageName, Xt as CREDENTIAL_ONLY_NODE_PREFIX, dt as AI_OTHERS_NODE_CREATOR_VIEW, jt as TRIGGER_NODE_CREATOR_VIEW, lt as AI_EVALUATION, mt as AI_UNCATEGORIZED_CATEGORY, ut as AI_NODE_CREATOR_VIEW, vt as DEFAULT_SUBCATEGORY, xt as HITL_SUBCATEGORY, yn as HTTP_REQUEST_NODE_TYPE } from "./constants-CtA9jyV-.js";
import "./merge-BLok1EPf.js";
import "./_baseOrderBy-B5lXBmMF.js";
import { t as useBannersStore } from "./banners.store-Du1NeDsO.js";
import "./dateformat-Bc6vycUF.js";
import { t as useDebounce } from "./useDebounce-BLyJcepV.js";
...
import { n as captureException } from "./exports-K2R0sMZo.js";
import "./semver-BgDpqpR3.js";
import { n as useNodeType } from "./usePinnedData-6cs4oFEc.js";
import { t as getNodeIconSource } from "./nodeIcon-Cc0Lmu9p.js";
import "./canvas.utils-CaIgedg0.js";
import { a as AIView, c as TriggerView, i as AINodesView, l as require_camelCase, n as useViewStacks, o as HitlToolView, r as useKeyboardNavigation, s as RegularView, t as useNodeCreatorStore } from "./nodeCreator.store-DRjAjMk5.js";
import "./useCanvasOperations-CtjMC9Vr.js";
import "./folders.store-Dx3ZI_kr.js";
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-DjD6AeYC.js";
import { t as NodeIcon_default } from "./NodeIcon-Be4Kw4K9.js";
import { t as useCalloutHelpers } from "./useCalloutHelpers-35vAQH3i.js";
import { t as useActions } from "./useActions-BzOloh0w.js";
import { t as SlideTransition_default } from "./SlideTransition-CWBy1p6w.js";
var _hoisted_1$10 = {
	viewBox: "0 0 24 24",
	width: "1.2em",
	height: "1.2em"
...
var CommunityNodeInstallHint_vue_vue_type_style_index_0_lang_module_default = { container: "_container_cosmc_125" };
...
function useQuickConnect({ credentialType, packageName }) {
	const settingsStore = useSettingsStore();
	const quickConnectEnabled = usePostHog().isVariantEnabled(QUICK_CONNECT_EXPERIMENT.name, QUICK_CONNECT_EXPERIMENT.variant);
	return computed(() => {
		if (quickConnectEnabled && settingsStore.moduleSettings["quick-connect"]?.options.length) return settingsStore.moduleSettings["quick-connect"]?.options.find((option) => option.credentialType === toRef(credentialType).value || option.packageName === toRef(packageName).value);
	});
}
...
var CommunityNodeInfo_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function fetchPackageInfo(packageName$1) {
			...
			const url = `https://registry.npmjs.org/${packageName$1}`;
			try {
				const response = await fetch(url);
				if (!response.ok) {
					captureException(/* @__PURE__ */ new Error("Could not get metadata for package"), { extra: { packageName: packageName$1 } });
					return;
				}
				publisherName.value = (await response.json()).maintainers?.[0]?.name;
				const downloadsUrl = `https://api.npmjs.org/downloads/range/2022-01-01:${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}/${packageName$1}`;
				const downloadsResponse = await fetch(downloadsUrl);
				if (!downloadsResponse.ok) {
					captureException(/* @__PURE__ */ new Error("Could not get downloads for package"), { extra: { packageName: packageName$1 } });
					return;
				}
				...
				captureException(error, { extra: { packageName: packageName$1 } });
			}
		}
		onMounted(async () => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.info) }, [
					...
					unref(quickConnect) ? (openBlock(), createElementBlock("div", _hoisted_3, [createVNode(unref(N8nIcon_default), {
						class: normalizeClass(_ctx.$style.tooltipIcon),
						icon: "quick-connect"
					}, null, 8, ["class"]), createVNode(unref(N8nText_default), {
						color: "text-light",
				...
				unref(quickConnect) ? (openBlock(), createBlock(QuickConnectBanner_default, {
					key: 2,
					text: unref(quickConnect)?.text
				}, null, 8, ["text"])) : createCommentVNode("", true),
				!isOwner.value && !unref(communityNodeDetails)?.installed ? (openBlock(), createBlock(ContactAdministratorToInstall_default, { key: 3 })) : createCommentVNode("", true)
			], 2);
		};
	}
});
var CommunityNodeInfo_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_o3pf2_125",
	nodeIcon: "_nodeIcon_o3pf2_134",
	description: "_description_o3pf2_139",
	separator: "_separator_o3pf2_143",
	info: "_info_o3pf2_149",
	tooltipIcon: "_tooltipIcon_o3pf2_164",
	contactOwnerHint: "_contactOwnerHint_o3pf2_170"
};
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.title) }, [
					...
					__props.rootView === unref("Regular") || __props.rootView === unref("Trigger") ? (openBlock(), createElementBlock("div", {
						...
						__props.rootView === unref("Trigger") ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createVNode(unref(N8nLink_default), { onClick: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("addWebhookNode")) }, {
							...
							_: 1
						}), createTextVNode(" " + toDisplayString(`${unref(i18n$1).baseText("nodeCreator.noResults.or")} `), 1)], 64)) : createCommentVNode("", true),
				...
				__props.showRequest ? (openBlock(), createElementBlock("div", {
					...
					default: withCtx(() => [createBaseVNode("span", null, toDisplayString(unref(i18n$1).baseText("nodeCreator.noResults.requestTheNode")), 1), createBaseVNode("span", null, [createVNode(unref(N8nIcon_default), {
