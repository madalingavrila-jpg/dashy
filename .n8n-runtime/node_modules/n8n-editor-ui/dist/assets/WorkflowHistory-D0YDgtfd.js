...
import { Bi as N8nButton_default, Ct as N8nLoading_default, Dt as N8nBadge_default, Hi as N8nIcon_default, Li as N8nHeading_default, St as N8nActionToggle_default, Ti as N8nTooltip_default, bi as useRoute, mt as createEventBus, pi as N8nLink_default, xi as useRouter, zi as N8nText_default } from "./src-BsVsetYf.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-DjneYy0u.js";
import { Dr as useWorkflowHistoryStore, Ir as useWorkflowsListStore, r as useUIStore, t as useUsersStore, xs as useSettingsStore, yr as useToast, zt as telemetry } from "./users.store-yKax6vGx.js";
import { Fs as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY, Gc as EnterpriseEditionFeature, Ko as getResourcePermissions, Ls as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Ps as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, ns as VIEWS } from "./constants-CtA9jyV-.js";
...
import { i as getLastPublishedVersion, n as formatTimestamp, r as generateVersionName, t as computeTimelineEntries } from "./utils-CzrkSDCm.js";
import { t as useWorkflowActivate } from "./useWorkflowActivate-k1iFAunP.js";
import { t as WorkflowPreview_default } from "./WorkflowPreview-B5RxEC7p.js";
import { t as useIntersectionObserver } from "./useIntersectionObserver-kAx2CFcf.js";
...
var WorkflowHistoryListItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const mainTooltipContent = computed(() => {
			...
			if (props.isVersionActive) return !!getPublishedUserName(lastPublishInfo.value?.userId) ? i18n.baseText("workflowHistory.item.publishedBy") : i18n.baseText("workflowHistory.item.active");
			if (props.index === 0 && !props.isVersionActive) return i18n.baseText("workflowHistory.item.currentChanges");
			if (versionPublishInfo.value) return !!getPublishedUserName(versionPublishInfo.value?.userId) ? i18n.baseText("workflowHistory.item.publishedBy") : i18n.baseText("workflowHistory.item.active");
...
var WorkflowHistoryListItem_vue_vue_type_style_index_0_lang_module_default = {
	item: "_item_t6iqo_125",
	grouped: "_grouped_t6iqo_136",
	selected: "_selected_t6iqo_136",
	wrapper: "_wrapper_t6iqo_154",
	timelineColumn: "_timelineColumn_t6iqo_168",
	timelineDot: "_timelineDot_t6iqo_179",
	timelineDotPublished: "_timelineDotPublished_t6iqo_186",
	timelineDotLatest: "_timelineDotLatest_t6iqo_190",
	timelineDotDefault: "_timelineDotDefault_t6iqo_194",
	timelineLine: "_timelineLine_t6iqo_199",
	content: "_content_t6iqo_207",
	mainRow: "_mainRow_t6iqo_215",
	mainLine: "_mainLine_t6iqo_221",
	metaRow: "_metaRow_t6iqo_227",
	metaAuthor: "_metaAuthor_t6iqo_235",
	metaTime: "_metaTime_t6iqo_243",
	unnamedRow: "_unnamedRow_t6iqo_248",
	unnamedAuthor: "_unnamedAuthor_t6iqo_255",
	unnamedTime: "_unnamedTime_t6iqo_263",
	actions: "_actions_t6iqo_268",
	publishedBadge: "_publishedBadge_t6iqo_275"
};
...
var WorkflowHistory_vue_vue_type_style_index_0_lang_module_default = {
	view: "_view_q2hup_125",
	header: "_header_q2hup_135",
	corner: "_corner_q2hup_143",
	contentComponentWrapper: "_contentComponentWrapper_q2hup_154",
