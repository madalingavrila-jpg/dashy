    ...
    _insert(data, upsert = false, enable_cache = true) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fieldOps = upsert
                ? this.normalizeFieldOps(data.field_ops)
                : [];
            ...
            const params = Object.assign(Object.assign(Object.assign(Object.assign({}, data), { num_rows: data.fields_data.length, schema_timestamp: collectionInfo.update_timestamp_str ||
                    collectionInfo.update_timestamp }), (upsert && isPartialUpdate ? { partial_update: true } : {})), (upsert && fieldOps.length > 0 ? { field_ops: fieldOps } : {}));
