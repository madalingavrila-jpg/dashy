 ...
 * @return {Number}
 */
declare const calculateExponentialRetryTime: (retryTime: number, retryConfigs: Pick<RetryMiddlewareOptions, 'factor' | 'multiplier' | 'maxRetryTimeInSecs'>) => number;
...
export { type AbortFn as A, BasicAuthMiddleware as B, type Context as C, DurationMiddleware as D, type ExcludeObject as E, type Milliseconds as F, GlobalErrorHandlerMiddleware as G, LogMiddleware as L, MethodDescriptor as M, type ParsedJSON as P, type RenewFn as R, TimeoutMiddleware as T, type MethodDescriptorParams as a, type Middleware as b, type MiddlewareDescriptor as c, type MiddlewareParams as d, Request as e, type RequestContext as f, type RequestGetter as g, Response as h, type ResponseGetter as i, type RetryMiddlewareOptions as j, REGEXP_CONTENT_TYPE_JSON as k, type ResponseParams as l, RetryMiddleware as m, type RetryMiddlewareProps as n, calculateExponentialRetryTime as o, defaultRetryConfigs as p, CsrfMiddleware as q, CONTENT_TYPE_JSON as r, EncodeJsonMiddleware as s, type ErrorHandlerMiddlewareCallback as t, setErrorHandler as u, defaultErrorLogger as v, defaultSuccessLogger as w, setErrorLogger as x, setLoggerEnabled as y, setSuccessLogger as z };
