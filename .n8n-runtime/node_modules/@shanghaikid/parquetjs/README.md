...
```
  $ npm install @shanghaikid/parquetjs
```
...
```javascript
import parquetjs from '@shanghaikid/parquetjs';
```
...
```javascript
// Common JS
'node_modules/@shanghaikid/parquetjs/dist/browser/parquetjs.cjs';
// ES Modules
'node_modules/@shanghaikid/parquetjs/dist/browser/parquetjs.esm';
```
...
```javascript
// Common JS
import parquetjs from '@shanghaikid/parquetjs/dist/browser/parquetjs.cjs';
// ES Modules
import parquetjs from '@shanghaikid/parquetjs/dist/browser/parquetjs.esm';
```
...
```js
var parquet = require('@shanghaikid/parquetjs');
```
